...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg bg-white dark:bg-surface rounded-2xl shadow-lg p-6 sm:p-8 lg:p-10 space-y-6">
        <div className="text-center">
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-on-surface">Apex Cuts</h1>
            <p className="text-gray-500 dark:text-on-surface-variant mt-2 text-sm sm:text-base">Welcome back, please log in to your account</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
            <button
              ...
              className="flex items-center justify-center py-2.5 px-4 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="flex items-center justify-center space-x-2">
            ...
            <span className="text-gray-500 dark:text-on-surface-variant text-sm">OR</span>
            <span className="h-px w-full bg-gray-300 dark:bg-gray-600"></span>
        </div>

        <form className="space-y-6" onSubmit={handleFormSubmit}>
            <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-600 dark:text-on-surface-variant mb-2">Email</label>
                <input type="email" id="email" defaultValue="admin@apexcuts.com" disabled={!!loadingProvider} className="w-full px-4 py-2.5 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-on-surface focus:ring-primary focus:border-primary transition text-sm sm:text-base disabled:opacity-50" />
            </div>
            <div>
                <label htmlFor="password"className="block text-sm font-medium text-gray-600 dark:text-on-surface-variant mb-2">Password</label>
                <input type="password" id="password" defaultValue="password" disabled={!!loadingProvider} className="w-full px-4 py-2.5 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-on-surface focus:ring-primary focus:border-primary transition text-sm sm:text-base disabled:opacity-50" />
            </div>
